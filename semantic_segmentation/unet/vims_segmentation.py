...
from utils_torchgeo import unbind_samples
...
class SemanticSegmentation(LightningModule):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        Keyword Args:
            ...
            class_weights: The weight tensor if classes are unbalanced
        Raises:
        ...
        self.class_weights = torch.ones(self.hyperparams["num_classes"]) if kwargs["class_weights"] is None else kwargs["class_weights"]
    ...
    def configure_optimizers(self) -> Dict[str, Any]:
        ...
        optimizer = torch.optim.Adam(
            self.model.parameters(), lr=self.hyperparams["learning_rate"],betas=self.hyperparams["betas"]
        )
        return {
            "optimizer": optimizer,
            "lr_scheduler": {

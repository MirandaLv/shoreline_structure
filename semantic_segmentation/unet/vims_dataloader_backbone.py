...
# # data_name = 'Image_after_2010_merged_256'
dataset_dir = os.path.join(up(up(up(__file__))), 'datasets') #, '256_images_lesstrain'
...
class GenDEBRIS(Dataset): # Extend PyTorch's Dataset class
    ...
    def __init__(self, mode = 'train', transform=None, standardization=None, data_name = "Image_after_2010_merged_256", path = dataset_dir):
        ...
        if os.path.isdir(os.path.join(dataset_dir, data_name)):
